...
instance1_id=$(aws ec2 run-instances --image-id ami-14c5486b --count 1 --instance-type t2.micro --key-name Pe_Rohan --security-group-ids sg-66323b2e --subnet-id subnet-de0385f2 --iam-instance-profile Name=PE_trainee_Admin_role --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=Rohan},
